...
import lab9.lab.repository.Repository;
...
public class RentalService {
    ...
    @Autowired
    private Repository<Rental, Long> rentalRepository;
    ...
    public void addRental(Rental rental) throws Exception {
        ...
        if(rental.getRentalSerial().isEmpty() || rental.getClientID()<0 || rental.getMovieID()<0)
    ...
    public void updateRental(Rental rental) throws Exception {
        ...
        rentalRepository.findById(rental.getId()).ifPresent(s->{
            ...
            s.setRentalSerial(rental.getRentalSerial());
     ...
     *  from its lab9.lab.repository(cascade deleting is called in console after deleting the given client)
     *
    ...
    public List<Rental> getAllRentalsSorted() throws Exception {
        ...
        log.trace("getAllRentalsSorted - method started");

        Iterable<Rental> rentals = rentalRepository.findAll(Sort.by(Sort.Direction.ASC, "id"));
        log.trace("getAllRentalsSorted - method to return");
