...
public class ClientService {
    ...
    public void updateClient(Client client) throws IOException, ClassNotFoundException, TransformerException, ParserConfigurationException, SQLException {
        ...
        clientRepository.findById(client.getId()).ifPresent(s->{ s.setName(client.getName()); s.setAge(client.getAge()); s.setSerial(client.getSerial()); s.setId(client.getId()); log.debug("updateClient - updated: s={}", s);});
